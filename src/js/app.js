...
/**
 * Ass event listener on multiple elements
...
function toggleSearch() { searchView.classList.toggle('active') }
  ...
  fetchData(url.currentWeather(lat, lon), (currentWeather) => {
    ...
    card.innerHTML = `
      ...
      <div class="weapper">
        ...
        <img src="src/images/weather_icons/${icon}.png" alt="${description}" class="weather-icon"
        width="64" height="64">
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        windLi.innerHTML = `
          <div class="card card-sm slider-card">
            ...
            <img src="src/images/weather_icons/direction.png" alt="direction" class="weather-icon"
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML = `
          <div class="icon-wrapper">
            ...
            <img src="src/images/weather_icons/${icon}.png" alt="${description}" class="weather-icon"
            width="36" height="36" title="${description}">
